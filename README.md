...
- Stable tags named `v*`, for example `v0.4.0`, build a GitHub Release using notes from `CHANGELOG.md`; routine `main` pushes do not create development tags.
