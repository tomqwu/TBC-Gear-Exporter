...
test("RefreshExport no-ops without frame and updates edit box with frame", function()
    ...
    assertTrue(Addon.exportFrame.adviceContent.height >= 616)
...
test("CreateExportFrame wires UI controls and scripts", function()
    ...
    assertEquals(exportFrame.comparePanel.points[1][5], -262)
    ...
    assertEquals(exportFrame.adviceRowsContent.points[1][5], -392)
